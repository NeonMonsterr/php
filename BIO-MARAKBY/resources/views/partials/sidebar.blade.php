<!-- Mobile Overlay -->
<div id="teacher-sidebar-overlay" class="fixed inset-0 bg-black bg-opacity-50 z-20 hidden md:hidden transition-opacity duration-200"></div>

<!-- Sidebar Component -->
<div id="teacher-sidebar" class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2 fixed inset-y-0 right-0 transform translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out z-30">
    <div class="flex items-center justify-between px-4">
        <h2 class="text-xl font-semibold">لوحة تحكم المعلم</h2>
        <button class="md:hidden text-white focus:outline-none" id="teacher-sidebar-close">
...
<button id="teacher-sidebar-open" class="md:hidden fixed top-4 right-4 text-gray-800 focus:outline-none z-40">
    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
