            ...
            <div class="card w-full">
                ...
                <form method="POST" action="{{ route('lectures.store', $course) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="course_id" id="course_id" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            ...
                            <option value="{{ $course_option->id }}"
                                {{ old('course_id', $course->id) == $course_option->id ? 'selected' : '' }}>
                                {{ $course_option->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="youtube_url" id="youtube_url" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="mb-4">
                        <label for="file" class="block text-gray-700 mb-2 font-semibold">ارفع ملف:</label>
                        <input type="file" name="file" id="file" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @error('file')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="position" id="position" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
