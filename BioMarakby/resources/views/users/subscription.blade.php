    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-4 sm:p-6 md:mr-64">
            <div class="max-w-md mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-md">
                ...
                <p class="text-gray-600 mb-4 text-sm sm:text-base">الدورة المسجلة: {{ $user->enrolledCourse?->name ?? 'لا يوجد' }}</p>
                <form method="POST" action="{{ route('users.subscription') }}">
                    ...
                    <button type="submit" class="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600">تحديث الاشتراك</button>
                </form>
