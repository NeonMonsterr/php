    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-4 sm:p-6">
            <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
                <h1 class="text-2xl font-bold text-gray-800 mb-6">إنشاء امتحان</h1>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('exams.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="form_url" id="form_url" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('form_url') }}" required>
                        @error('form_url')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="date" name="exam_date" id="exam_date" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('exam_date') }}" required>
                        @error('exam_date')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <button type="submit" class="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600">إنشاء الامتحان</button>
                </form>
